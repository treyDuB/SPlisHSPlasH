...
function(do_fetch)
  ...
  execute_process(
    COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git fetch --tags --force "origin"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters"
...
execute_process(
  COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git show-ref "a4e2744eea526270cfe38b826440d09f66473316"
  WORKING_DIRECTORY "C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "a4e2744eea526270cfe38b826440d09f66473316")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("a4e2744eea526270cfe38b826440d09f66473316" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/a4e2744eea526270cfe38b826440d09f66473316")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"a4e2744eea526270cfe38b826440d09f66473316\" is not present locally, and not "
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters"
...
execute_process(
  COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters'."
    ...
    execute_process(
      COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters"
    )
    execute_process(
      COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters"
      )
      execute_process(
        COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Release/extern/GenericParameters/src/Ext_GenericParameters'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
