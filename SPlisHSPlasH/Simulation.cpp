...
void Simulation::addFluidModel(const std::string &id, const unsigned int nFluidParticles, Vector3r* fluidParticles, Vector3r* fluidVelocities, std::vector<Real> fluidRadius, unsigned int* fluidObjectIds, const unsigned int nMaxEmitterParticles, unsigned int levels, unsigned int level0)
{
	FluidModel *fm = new FluidModel();
	fm->initModel(id, nFluidParticles, fluidParticles, fluidVelocities, fluidRadius, m_particleRadius, fluidObjectIds, nMaxEmitterParticles, levels, level0);
