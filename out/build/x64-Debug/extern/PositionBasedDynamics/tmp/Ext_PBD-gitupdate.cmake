...
execute_process(
  COMMAND "D:/GIT/Git/cmd/git.exe" --git-dir=.git show-ref "00db2e091a88a628099787cf6fada941e851dbfa"
  WORKING_DIRECTORY "C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Debug/extern/PositionBasedDynamics/src/Ext_PBD"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "00db2e091a88a628099787cf6fada941e851dbfa")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("00db2e091a88a628099787cf6fada941e851dbfa" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/00db2e091a88a628099787cf6fada941e851dbfa")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"00db2e091a88a628099787cf6fada941e851dbfa\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Debug/extern/PositionBasedDynamics/src/Ext_PBD'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Trey/source/repos/SPlisHSPlasH/out/build/x64-Debug/extern/PositionBasedDynamics/src/Ext_PBD'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
